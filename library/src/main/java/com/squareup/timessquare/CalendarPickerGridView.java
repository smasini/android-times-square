 ...
 * Created by simone on 18/09/15 at 09:37.
 */
public class CalendarPickerGridView extends GridView{
    ...
    public CalendarPickerGridView(Context context, AttributeSet attrs) {
        ...
        final int bg = a.getColor(R.styleable.CalendarPickerGridView_android_background,
                res.getColor(R.color.calendar_bg));
        dividerColor = a.getColor(R.styleable.CalendarPickerGridView_tsquaregrid_dividerColor,
                res.getColor(R.color.calendar_divider));
        dayBackgroundResId = a.getResourceId(R.styleable.CalendarPickerGridView_tsquaregrid_dayBackground,
                R.drawable.calendar_bg_selector);
        dayTextColorResId = a.getResourceId(R.styleable.CalendarPickerGridView_tsquaregrid_dayTextColor,
                R.color.calendar_text_selector);
        titleTextColor = a.getColor(R.styleable.CalendarPickerGridView_tsquaregrid_titleTextColor,
                res.getColor(R.color.calendar_text_active));
        displayHeader = a.getBoolean(R.styleable.CalendarPickerGridView_tsquaregrid_displayHeader, true);
        headerTextColor = a.getColor(R.styleable.CalendarPickerGridView_tsquaregrid_headerTextColor,
                res.getColor(R.color.calendar_text_active));
        a.recycle();
